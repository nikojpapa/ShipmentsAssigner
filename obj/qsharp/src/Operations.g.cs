...
[assembly: Microsoft.Quantum.QsCompiler.Attributes.CallableDeclaration("{\"Kind\":{\"Case\":\"Operation\"},\"QualifiedName\":{\"Namespace\":\"ShipmentsAssigner\",\"Name\":\"_OracleImplImpl\"},\"SourceFile\":\"/Users/nicholaspapadopoulos/Box%20Sync/CS/Me/quantum/Boyle/ShipmentsAssigner/Operations.qs\",\"Position\":{\"Item1\":249,\"Item2\":4},\"SymbolRange\":{\"Item1\":{\"Line\":1,\"Column\":11},\"Item2\":{\"Line\":1,\"Column\":26}},\"ArgumentTuple\":{\"Case\":\"QsTuple\",\"Fields\":[[{\"Case\":\"QsTupleItem\",\"Fields\":[{\"VariableName\":{\"Case\":\"ValidName\",\"Fields\":[\"qIndex\"]},\"Type\":{\"Case\":\"ArrayType\",\"Fields\":[{\"Case\":\"Qubit\"}]},\"IsMutable\":false,\"HasLocalQuantumDependency\":false,\"Position\":{\"Case\":\"Null\"},\"Range\":{\"Item1\":{\"Line\":2,\"Column\":13},\"Item2\":{\"Line\":2,\"Column\":19}}}]},{\"Case\":\"QsTupleItem\",\"Fields\":[{\"VariableName\":{\"Case\":\"ValidName\",\"Fields\":[\"zeroTest\"]},\"Type\":{\"Case\":\"Qubit\"},\"IsMutable\":false,\"HasLocalQuantumDependency\":false,\"Position\":{\"Case\":\"Null\"},\"Range\":{\"Item1\":{\"Line\":3,\"Column\":13},\"Item2\":{\"Line\":3,\"Column\":21}}}]},{\"Case\":\"QsTupleItem\",\"Fields\":[{\"VariableName\":{\"Case\":\"ValidName\",\"Fields\":[\"time\"]},\"Type\":{\"Case\":\"ArrayType\",\"Fields\":[{\"Case\":\"Qubit\"}]},\"IsMutable\":false,\"HasLocalQuantumDependency\":false,\"Position\":{\"Case\":\"Null\"},\"Range\":{\"Item1\":{\"Line\":4,\"Column\":13},\"Item2\":{\"Line\":4,\"Column\":17}}}]},{\"Case\":\"QsTupleItem\",\"Fields\":[{\"VariableName\":{\"Case\":\"ValidName\",\"Fields\":[\"lastTime\"]},\"Type\":{\"Case\":\"ArrayType\",\"Fields\":[{\"Case\":\"Qubit\"}]},\"IsMutable\":false,\"HasLocalQuantumDependency\":false,\"Position\":{\"Case\":\"Null\"},\"Range\":{\"Item1\":{\"Line\":5,\"Column\":13},\"Item2\":{\"Line\":5,\"Column\":21}}}]},{\"Case\":\"QsTupleItem\",\"Fields\":[{\"VariableName\":{\"Case\":\"ValidName\",\"Fields\":[\"toggle\"]},\"Type\":{\"Case\":\"Qubit\"},\"IsMutable\":false,\"HasLocalQuantumDependency\":false,\"Position\":{\"Case\":\"Null\"},\"Range\":{\"Item1\":{\"Line\":6,\"Column\":13},\"Item2\":{\"Line\":6,\"Column\":19}}}]}]]},\"Signature\":{\"TypeParameters\":[],\"ArgumentType\":{\"Case\":\"TupleType\",\"Fields\":[[{\"Case\":\"ArrayType\",\"Fields\":[{\"Case\":\"Qubit\"}]},{\"Case\":\"Qubit\"},{\"Case\":\"ArrayType\",\"Fields\":[{\"Case\":\"Qubit\"}]},{\"Case\":\"ArrayType\",\"Fields\":[{\"Case\":\"Qubit\"}]},{\"Case\":\"Qubit\"}]]},\"ReturnType\":{\"Case\":\"UnitType\"},\"SupportedFunctors\":[{\"Case\":\"Adjoint\"}]},\"Documentation\":[]}")]
...
#line hidden
    ...
    public class _OracleImplImpl : Adjointable<(QArray<Qubit>,Qubit,QArray<Qubit>,QArray<Qubit>,Qubit)>, ICallable
    {
        public _OracleImplImpl(IOperationFactory m) : base(m)
        {
        }

        public class In : QTuple<(QArray<Qubit>,Qubit,QArray<Qubit>,QArray<Qubit>,Qubit)>, IApplyData
        {
            public In((QArray<Qubit>,Qubit,QArray<Qubit>,QArray<Qubit>,Qubit) data) : base(data)
            {
            }
        ...
        public override Func<(QArray<Qubit>,Qubit,QArray<Qubit>,QArray<Qubit>,Qubit), QVoid> Body => (__in) =>
        {
            var (qIndex,zeroTest,time,lastTime,toggle) = __in;
...
#line 261 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/Boyle/ShipmentsAssigner/Operations.qs"
            UtilsCompareXIfAllZero.Apply((qIndex?.Copy(), zeroTest));
...
#line hidden
        ...
        ;
        public override Func<(QArray<Qubit>,Qubit,QArray<Qubit>,QArray<Qubit>,Qubit), QVoid> AdjointBody => (__in) =>
        {
            var (qIndex,zeroTest,time,lastTime,toggle) = __in;
#line hidden
            UtilsCompareXIfLessThanOrEqual.Adjoint.Apply((time?.Copy(), lastTime?.Copy(), toggle));
#line hidden
            UtilsCompareXIfAllZero.Adjoint.Apply((qIndex?.Copy(), zeroTest));
#line hidden
...
#line hidden
        ...
        public override IApplyData __dataIn((QArray<Qubit>,Qubit,QArray<Qubit>,QArray<Qubit>,Qubit) data) => new In(data);
        public override IApplyData __dataOut(QVoid data) => data;
        public static System.Threading.Tasks.Task<QVoid> Run(IOperationFactory __m__, QArray<Qubit> qIndex, Qubit zeroTest, QArray<Qubit> time, QArray<Qubit> lastTime, Qubit toggle)
        {
            return __m__.Run<_OracleImplImpl, (QArray<Qubit>,Qubit,QArray<Qubit>,QArray<Qubit>,Qubit), QVoid>((qIndex, zeroTest, time, lastTime, toggle));
        }
    }
    ...
    public class _OracleImpl : Adjointable<(Int64,Int64,QArray<QArray<Qubit>>,Database,Int64,Int64,QArray<Qubit>,Microsoft.Quantum.Canon.LittleEndian,QArray<Qubit>)>, ICallable
    {
        ...
        protected IAdjointable<(QArray<Qubit>,Qubit,QArray<Qubit>,QArray<Qubit>,Qubit)> _OracleImplImpl
        {
            get;
            set;
        }
...
#line 296 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/Boyle/ShipmentsAssigner/Operations.qs"
                    _OracleImplImpl.Apply((qIndex?.Copy(), zeroTest, time?.Copy(), lastTime?.Copy(), toggle));
...
#line 303 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/Boyle/ShipmentsAssigner/Operations.qs"
                    _OracleImplImpl.Adjoint.Apply((qIndex?.Copy(), zeroTest, time?.Copy(), lastTime?.Copy(), toggle));
...
#line hidden
                    _OracleImplImpl.Adjoint.Adjoint.Apply((qIndex?.Copy(), zeroTest, time?.Copy(), lastTime?.Copy(), toggle));
#line hidden
...
#line hidden
        ...
        public override void Init()
        {
            ...
            this._OracleImplImpl = this.Factory.Get<IAdjointable<(QArray<Qubit>,Qubit,QArray<Qubit>,QArray<Qubit>,Qubit)>>(typeof(_OracleImplImpl));
        }
